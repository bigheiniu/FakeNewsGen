...
class Block(nn.Module):
    ...
    def forward(self, inputs, layer_past=None, attention_mask=None, head_mask=None):
        output_attn = self.attn(
            self.ln_1(inputs), layer_past=layer_past, attention_mask=attention_mask, head_mask=head_mask
        )
